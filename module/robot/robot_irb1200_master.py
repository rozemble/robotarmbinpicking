...
#이 파이선 코드는
import os, sys
from module.robot.robot_irb1200_slave import Robot_Slave_irb1200

class Robot_Master_irb1200():
	def __init__(self):
		self.m_Robot_Slave = Robot_Slave_irb1200()
	...
	def get_pos(self):
		return self.m_Robot_Slave.get_cartesian()

	def get_joints(self):
		return self.m_Robot_Slave.get_cur_joints()
